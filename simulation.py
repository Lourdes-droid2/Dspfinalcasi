...
def create_rir_example(base_output_filename_prefix, rt60_tgt, room_dim, source_pos, mic_positions, fs, is_anechoic=False):
    ...
    try:
        ...
        room = pra.ShoeBox(
            room_dim, fs=fs1, materials=pra.Material(e_absorption), max_order=current_max_order
        )
...
if __name__ == "__main__":
    ...
    elevations = [-30, -15, 0, 15, 30, 60]  # Ángulos de elevación en grados
    mic_separations = [0.05, 0.10, 0.20] 
